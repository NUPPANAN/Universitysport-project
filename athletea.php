...
<body>
    <header>
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td style='color:white'>
                                <a href="editAthletepage.php?id=<?php echo $row['id'] ?>" class="link-dark"><i
                                        class="fa-solid fa-pen-to-square fs-5 me-3" style="color: #ffffff;"></i></a>
                                <a href="deleteAthelepage.php?id=<?php echo $row['id'] ?>" class="link-dark"><i
        ...
        <div class="container">
            <a href="addAthelepage.php" class="btn btn-dark">Add New</a>
        </div>
