...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `memberlist`(`id`, `Title`, `Name`, `Lastname`, `Department`, `Color`) VALUES (NULL,'$Title','$Name','$Lastname','$Department','$Color')";

    $result = mysqli_query($conn, $sql);

    if ($result) {
        header("Location: memberlista.php?msg=New Member have save!");
    } else {
